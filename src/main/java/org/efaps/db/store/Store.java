...
public final class Store extends AbstractAdminObject
{
     ...
     */
    private Map<String, String> getProperties(final long _id) throws EFapsException
    {
        final Map<String, String> ret = new HashMap<String, String>();
        final SearchQuery query = new SearchQuery();
        query.setQueryTypes(Type.get(EFapsClassNames.ADMIN_COMMON_PROPERTY).getName());
    ...
    public static class StoreCache extends Cache<Store>
    {
         ...
         */
        @Override
        protected void readCache(final Map<Long, Store> _cache4Id, final Map<String, Store> _cache4Name,
                        final Map<UUID, Store> _cache4UUID) throws CacheReloadException
        {
            try {
                final SearchQuery query = new SearchQuery();
