 ...
 * @version $Id$
 */
public class XSLImporter extends AbstractSourceImporter {

  /**
   * @param _url
   * @throws EFapsException
   */
  public XSLImporter(final URL _url) throws EFapsException {
    super(_url);
  }

  /**
   * Searches for the given name the xsl in eFaps. If exists, the instance is
   * returned.
   *
   * @return found instance (or null if not found)
   * @throws EFapsException
   *           if search query could not be executed
   * @see #programName
   */
  @Override
