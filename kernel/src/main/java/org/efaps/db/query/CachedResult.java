...
public class CachedResult {
   ...
   * in the cached result. The column set specified with parameter
   ...
   * The method does not set the cursor of the
   ...
   * value is converted in a string and then parsed as long.<br/> In the case
   * that the result was a multiple result only the first value will be returned!
   *
   * @param _index
   *          column index
