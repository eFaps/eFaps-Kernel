...
public class XMLPersonPrincipal extends XMLAbstractPrincipal  {
  ...
  /***
   * The organisation name of this person is stored in this instance variable.
   *
   * @see #getOrganisation
   * @see #setOrganisation
   */
  ...
  /**
   * Returns the organisation name of this person principal stored in instance 
   * variable {@link #organisation}.
   *
   * @return organisation name of this person principal
   * @see #organisation
   * @see #setOrganisation
   */
   ...
   * {@link #url}.
   *
   * @return url adress of this person principal
   * @see #url
   * @see #setUrl
   */
  ...
  /**
   * Sets the url adress of this person principal stored in instance variable
   * {@link #url}. The method must be public, because it is set from the
   * XML to bean converter in {@link XMLUserLoginModule}.
   *
   * @param _url new url adress to set for this person principal
   * @see #url
   * @see #getUrl
   */
  ...
  /**
   * Sets the phone number of this person principal stored in instance variable
   * {@link #phone}. The method must be public, because it is set from the
   * XML to bean converter in {@link XMLUserLoginModule}.
   *
