...
with (TYPE)  {
  with (addAttribute("OID"))  {
    ...
    setSQLTable("Admin_User_JAASKeySQLTable");
    setSQLColumn("ID");
  }
  ...
  with (addAttribute("JAASSystemLink"))  {
    setAttributeType("Link");
    setTypeLink("Admin_User_JAASSystem");
    setSQLTable("Admin_User_JAASKeySQLTable");
    setSQLColumn("USERJAASSYSTEM");
  }
  ...
  addProperty("Icon",                   "${ROOTURL}/servlet/image/Admin_User_JAASKeyImage");
  addProperty("Tree",                   "Admin_User_JAASKeyTree");
}
