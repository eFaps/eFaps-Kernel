...
/**
 * Class used to import css programs into eFaps.
 *
 * @author jmox
 * @version $Id$
 */
public class CSSImporter extends AbstractSourceImporter {

  /**
   * @param _url URL of the css file
   * @throws EFapsException on error
   */
  public CSSImporter(final URL _url) throws EFapsException {
    super(_url);
  }
  ...
  public Instance searchInstance() throws EFapsException {
    ...
    final Type esjpType = Type.get(ADMIN_PROGRAM_CSS);
